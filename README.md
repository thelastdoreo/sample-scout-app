...
| Platform | Installer |
|----------|-----------|
| macOS | [Sample-Scout_1.2.3_universal.dmg](https://github.com/thelastdoreo/sample-scout-app/releases/download/v1.2.3/Sample-Scout_1.2.3_universal.dmg) |
| Windows | [Sample-Scout_1.2.3_x64-setup.exe](https://github.com/thelastdoreo/sample-scout-app/releases/download/v1.2.3/Sample-Scout_1.2.3_x64-setup.exe) |
| Linux | [Sample-Scout_1.2.3_amd64.deb](https://github.com/thelastdoreo/sample-scout-app/releases/download/v1.2.3/Sample-Scout_1.2.3_amd64.deb) |
<!-- DOWNLOADS_END -->
