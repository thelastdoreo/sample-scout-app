...
| Platform | Installer |
|----------|-----------|
| macOS | [Sample-Scout_1.2.1_universal.dmg](https://github.com/thelastdoreo/sample-scout-app/releases/download/v1.2.1/Sample-Scout_1.2.1_universal.dmg) |
| Windows | [Sample-Scout_1.2.1_x64-setup.exe](https://github.com/thelastdoreo/sample-scout-app/releases/download/v1.2.1/Sample-Scout_1.2.1_x64-setup.exe) |
| Linux | [Sample-Scout_1.2.1_amd64.deb](https://github.com/thelastdoreo/sample-scout-app/releases/download/v1.2.1/Sample-Scout_1.2.1_amd64.deb) |
<!-- DOWNLOADS_END -->
