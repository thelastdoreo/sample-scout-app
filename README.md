...
| Platform | Installer |
|----------|-----------|
| macOS | [Sample-Scout_1.2.2_universal.dmg](https://github.com/thelastdoreo/sample-scout-app/releases/download/v1.2.2/Sample-Scout_1.2.2_universal.dmg) |
| Windows | [Sample-Scout_1.2.2_x64-setup.exe](https://github.com/thelastdoreo/sample-scout-app/releases/download/v1.2.2/Sample-Scout_1.2.2_x64-setup.exe) |
| Linux | [Sample-Scout_1.2.2_amd64.deb](https://github.com/thelastdoreo/sample-scout-app/releases/download/v1.2.2/Sample-Scout_1.2.2_amd64.deb) |
<!-- DOWNLOADS_END -->
